...
import oio.sts.sagdok.sagdokumentindeks._1_2_4.OpdaterSagIndeksInputType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="AttributListe" type="{urn:oio:sts:sagdok:sag:1.2.4.0}AttributListeType" minOccurs="0"/&gt;
 *         &lt;element name="TilstandListe" type="{urn:oio:sts:sagdok:sag:1.2.4.0}TilstandListeType" minOccurs="0"/&gt;
 *         &lt;element name="RelationListe" type="{urn:oio:sts:sagdok:sag:1.2.4.0}RelationListeType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlSeeAlso({
    OpdaterSagIndeksInputType.class
})
