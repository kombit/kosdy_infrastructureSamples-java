...
public class RequestSecurityTokenResponseType {
    ...
    public RequestSecurityTokenResponseType withAny(Object... values) {
        if (values!= null) {
    ...
    public RequestSecurityTokenResponseType withAny(Collection<Object> values) {
        if (values!= null) {
    ...
    public RequestSecurityTokenResponseType withContext(String value) {
        setContext(value);
        return this;
    }
