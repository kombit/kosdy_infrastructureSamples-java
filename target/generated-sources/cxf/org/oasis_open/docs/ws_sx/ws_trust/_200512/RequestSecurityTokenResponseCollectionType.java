...
public class RequestSecurityTokenResponseCollectionType {
    ...
    public RequestSecurityTokenResponseCollectionType withRequestSecurityTokenResponse(RequestSecurityTokenResponseType... values) {
        if (values!= null) {
            for (RequestSecurityTokenResponseType value: values) {
                getRequestSecurityTokenResponse().add(value);
            }
        }
        return this;
    }

    public RequestSecurityTokenResponseCollectionType withRequestSecurityTokenResponse(Collection<RequestSecurityTokenResponseType> values) {
        if (values!= null) {
            getRequestSecurityTokenResponse().addAll(values);
        }
        return this;
    }
