...
public class RequestSecurityTokenType {
    ...
    public RequestSecurityTokenType withAny(Object... values) {
        if (values!= null) {
    ...
    public RequestSecurityTokenType withAny(Collection<Object> values) {
        if (values!= null) {
    ...
    public RequestSecurityTokenType withContext(String value) {
        setContext(value);
        return this;
    }
