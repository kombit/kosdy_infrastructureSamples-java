                ...
                .withSoegUdtryk(new SoegUdtrykType()
                        .withSoegBevillingIndeksOrSoegOekonomiskEffektueringIndeksOrNOT(List.of(new oio.sts.ydelse.bevillingindeks._6.ObjectFactory()
                                .createSoegInput(new oio.sts.ydelse.bevillingindeks._6.SoegInputType()
                                        ...
                                        .withRelationListe(new oio.sts.ydelse.bevillingindeks._6.RelationListeType()
                                                .withBevillingssag(List.of(new oio.sts.ydelse.bevillingindeks._6.BevillingIndeksSagRelationType()
                                                        .withBrugervendtNoegle("2020-123456789")
                                                        .withFuldtNavn("Folkepension")
                                                        .withVirkning(new VirkningType()
                                                                .withFraTidspunkt(new TidspunktType()
                                                                        .withTidsstempelDatoTid(SoapUtils.getXmlCalender("2024-01-01T12:00:00"))
                                                                        .withGraenseIndikator(Boolean.valueOf(false)))
                                                        ...
                                                        .withRolle(new UnikIdType()
                                                                .withUUIDIdentifikator("31237487-787a-424f-8819-56aaedf00643") // Mandatory
                                                        )
                                                        .withType(new UnikIdType()
                                                                .withUUIDIdentifikator("f08a4a13-2567-41d0-bf8d-3af754b03464") // Mandatory
                                                        )
                                                        .withIndeks() // BLANK / NEVER TO BE UTILIZED
                                                        .withReferenceID(new UnikIdType()
                                                                .withUUIDIdentifikator("1111aaaa-11aa-22bb-33cc-111111aaaaaa") // Mandatory
                                                ...
                                                .withBevillingsaktoer(List.of(new oio.sts.ydelse.bevillingindeks._6.BevillingIndeksAktoerRelationType()
                                                        .withBrugervendtNoegle() // Optional / Not used in this example, as UUID is utilized
                                                        .withFuldtNavn("Udbetaling Danmark")
                                                        .withCVRNr("33236239")
                                                        .withVirkning(new VirkningType()
                                                                .withFraTidspunkt(new TidspunktType()
                                                        ...
                                                        .withReferenceID(new UnikIdType()
                                                                .withUUIDIdentifikator() // Mandatory / Derived from Fælleskommunal Organisation
                                                                .withURNIdentifikator() // Not filled, as UUID from Fælleskommunal Organisation is found
                                                        )
                                                        .withLokalUdvidelseListe(new LokalUdvidelseListeType() // FOLLOW UP
                                                                .withSenestAendretTidspunkt(SoapUtils.getXmlCalender())
                                                                .withAny(List.of())
                                                ...
                                                .withSikkerhedsprofil(List.of(new oio.sts.ydelse.bevillingindeks._6.SikkerhedsprofilRelationType() // OPTIONAL // POTENTIALLY TO BE REMOVED FROM CODE EXAMPLE
                                                        .withVirkning(new VirkningType()
                                                                .withFraTidspunkt(new TidspunktType()
                                                                        .withTidsstempelDatoTid(SoapUtils.getXmlCalender()) // OPTIONAL
                                                                        .withGraenseIndikator(Boolean.valueOf())) // OPTIONAL
                                                                .withTilTidspunkt(new TidspunktType()
                                                                        .withTidsstempelDatoTid(SoapUtils.getXmlCalender()) // OPTIONAL
                                                                        .withGraenseIndikator(Boolean.valueOf())
                                                                )
                                                ...
                                                .createSoegInput(new oio.sts.ydelse.bevillingindeks._6.SoegInputType()
                                                        .withAttributListe(new oio.sts.ydelse.bevillingindeks._6.AttributListeType()
                                                                .withEgenskaber(List.of(new oio.sts.ydelse.bevillingindeks._6.EgenskaberType()
                                                                        .withVirkning(new VirkningType()
                                                                                .withFraTidspunkt(new TidspunktType()
                                                                                        .withTidsstempelDatoTid(SoapUtils.getXmlCalender("2024-01-01T00:00:00"))
                                                                                        .withGraenseIndikator(Boolean.valueOf(false)))
                                                                                .withTilTidspunkt(new TidspunktType()
                                                                                        .withTidsstempelDatoTid(SoapUtils.getXmlCalender("2024-03-31T12:00:00"))
                                                                                        .withGraenseIndikator(Boolean.valueOf(false)))
                                                                                )
                                                                                .withAktoerRef(new UnikIdType()
                                                                                        .withUUIDIdentifikator("9999aaaa-11aa-22bb-33cc-111111aaaaaa")
                                                                                        .withURNIdentifikator() // Blank, as examples utilizes UUID, could be either, but only one
                                                                                )
                                                                                .withAktoerTypeKode(AktoerTypeKodeType.fromValue("Bruger"))
                                                                                .withNoteTekst() // Optional
                                                                        )
                                                                        .withBrugervendtNoegle("2020-123456789")
                                                                        .withBevillingstartdato() // BLANK
                                                                        .withBevillingslutdato() // BLANK
                                                                        .withBegrundelse() // OPTIONAL
                                                                        .withFoelsomhed(oio.sts.ydelse.bevillingindeks._6.FoelsomhedType.fromValue("FORTROLIGE_PERSONOPLYSNINGER"))))
                                                                .withBevilgetYdelse(List.of(new oio.sts.ydelse.bevillingindeks._6.BevilgetYdelseType()
                                                                        .withVirkning(new VirkningType()
                                                                        ...
                                                                        .withId("1")
                                                                        .withNavn("Folkepension")
                                                                        .withBevilgetYdelseStartdato(SoapUtils.getXmlCalender("2024-01-01T00:00:00"))
                                                                        .withBevilgetYdelseSlutdato(SoapUtils.getXmlCalender())
                                                                        .withBegrundelse()
                                                                        .withTilbagebetalingspligtig(Boolean.valueOf()) // Optional ; Either True or False
                                                                        .withMeddelelse()
                                                                        .withItSystem(List.of(new oio.sts.ydelse.bevillingindeks._6.ItSystemRelationType()
                                                                                .withSystemNavn("UDK Pension")
                                                                                .withSystemURI()
                                                                                .withRolle(new UnikIdType()
                                                                                        .withUUIDIdentifikator("251c24fd-57b0-4afc-9d73-b063d1957eb3")
                                                                                ...
                                                                                .withIndeks()
                                                                                .withReferenceID(new UnikIdType()
                                                                                        .withUUIDIdentifikator("ba537e12-8b0c-44b1-9de7-f75803a4e091")
                                                                                )
                                                                                .withLokalUdvidelseListe(new LokalUdvidelseListeType() // FOLLOW UP
                                                                                        .withSenestAendretTidspunkt(SoapUtils.getXmlCalender())
                                                                                        .withAny(List.of())
                                                                        ...
                                                                        .withYdelse(new oio.sts.ydelse.bevillingindeks._6.YdelseRelationType()
                                                                                .withYdelsesnavn("Grundbeløb - FOP")
                                                                                .withKlassifikation(new oio.sts.ydelse.bevillingindeks._6.BevillingsklasseRelationType()
                                                                                        .withBrugervendtNoegle("32.03.04")
                                                                                        .withKlassetitel("Folkepension")
                                                                                )
                                                                                .withRolle(new UnikIdType()
                                                                                        .withUUIDIdentifikator("6ebd938f-0bbf-4142-a65c-fefe15e9f192")
                                                                                )
                                                                                .withType(new UnikIdType()
                                                                                        .withUUIDIdentifikator("3aa45cbd-94c3-4601-84a6-66ce0f157dda")
                                                                                )
                                                                                .withIndeks("1")
                                                                                .withReferenceID(new UnikIdType()
                                                                                        .withUUIDIdentifikator("2637c22e-06b8-4f8c-9520-42e4de177203")
                                                                                )
                                                                                .withLokalUdvidelseListe(new LokalUdvidelseListeType() // FOLLOW UP
                                                                                        .withSenestAendretTidspunkt(SoapUtils.getXmlCalender())
                                                                                        .withAny(List.of())
                                                                        ...
                                                                        .withOekonomiskEffektueringsplan(List.of(new oio.sts.ydelse.bevillingindeks._6.OekonomiskEffektueringsplanType()
                                                                                .withId("1")
                                                                                .withEffektueringsplanStartdato(SoapUtils.getXmlCalender("2024-01-01T12:00:00"))
                                                                                .withEffektueringsplanSlutdato(SoapUtils.getXmlCalender("2024-01-31T12:00:00"))
                                                                                .withBeregningsfrekvens("7772f4e3-b06d-4ef8-b599-9134cf3fdee4")
                                                                                .withForudBagud("Bagud")
                                                                                .withDispositionsdag("Sidste bankdag i måneden")
                                                                                .withYdelsesbeloeb("6694")
                                                                                .withManueltGodkendes(Boolean.valueOf())
                                                                        )))
                                                                )
                                                        )
                                                        .withTilstandListe(new oio.sts.ydelse.bevillingindeks._6.TilstandListeType() // FOLLOW UP
                                                        ...
                                                        .withRelationListe(new oio.sts.ydelse.bevillingindeks._6.RelationListeType()
                                                                .withBevillingssag(List.of(new oio.sts.ydelse.bevillingindeks._6.BevillingIndeksSagRelationType()
                                                                        ...
                                                                        .withIndeks() //
                                                                        .withReferenceID(new UnikIdType()
                                                                                .withUUIDIdentifikator("1111aaaa-11aa-22bb-33cc-111111aaaaaa")
                                                                        )
                                                                        .withLokalUdvidelseListe(new LokalUdvidelseListeType() // Follow up
                                                                                .withSenestAendretTidspunkt(SoapUtils.getXmlCalender())
                                                                                .withAny(List.of())
                                                                ...
                                                                .withBevillingspart(List.of(new oio.sts.ydelse.bevillingindeks._6.BevillingIndeksPartRelationType()
                                                                        ...
                                                                        .withIndeks("1")
                                                                        .withReferenceID(new UnikIdType()
                                                                                .withUUIDIdentifikator() // Either UUID or URN
                                                                                .withURNIdentifikator("urn:oio:cpr-nr:0123456789")
                                                                        )
                                                                        .withLokalUdvidelseListe(new LokalUdvidelseListeType() // Follow up
                                                                                .withSenestAendretTidspunkt(SoapUtils.getXmlCalender("ÆØÅ"))
                                                                                .withAny(List.of("ÆØÅ"))
                                                                ...
                                                                .withSikkerhedsprofil(List.of(new oio.sts.ydelse.bevillingindeks._6.SikkerhedsprofilRelationType() // Searchable, but not utilized in Sags- & Dokumentindeks
                                                                        .withVirkning(new VirkningType()
                                                                                .withFraTidspunkt(new TidspunktType()
                                                                                        .withTidsstempelDatoTid(SoapUtils.getXmlCalender())
                                                                                        .withGraenseIndikator(Boolean.valueOf()))
                                ...
                                .createSoegInput(new oio.sts.ydelse.oekonomiskeffektueringindeks._6.SoegInputType()
                                        .withAttributListe(new oio.sts.ydelse.oekonomiskeffektueringindeks._6.AttributListeType()
                                                .withEgenskaber(List.of(new oio.sts.ydelse.oekonomiskeffektueringindeks._6.EgenskaberType()
                                                        ...
                                                        .withBrugervendtNoegle("1607371985039P")
                                                        .withStartdato(SoapUtils.getXmlCalender("2024-01-01T12:00:00"))
                                                        .withSlutdato(SoapUtils.getXmlCalender("2024-01-31T12:00:00"))
                                                        .withSamletBruttobeloeb("5942")
                                                        .withDispositionsdato(SoapUtils.getXmlCalender("2024-01-31T12:00:00"))
                                                        .withBeloebEfterSkatATP("3744")
                                                        .withBeloebSendtTilUdbetaling("3744")
                                                        .withBeloebUdbetalt("3744")
                                                        .withUdbetalingsafdeling("Udbetaling Danmark")
                                                        .withSendtTilUdbetalingTekst()
                                                        .withUdbetaltTekst()
                                                ))
                                                .withLokalUdvidelseListe(new LokalUdvidelseListeType() // Follow up
                                                        .withSenestAendretTidspunkt(SoapUtils.getXmlCalender())
                                        ...
                                        .withRelationListe(new oio.sts.ydelse.oekonomiskeffektueringindeks._6.RelationListeType()
                                                ...
                                                .withItSystem(List.of(new oio.sts.ydelse.oekonomiskeffektueringindeks._6.ItSystemRelationType()
                                                        .withSystemNavn("UDK Pension")
                                                        .withSystemURI() // Blank / Not to be utilized
                                                        .withRolle(new UnikIdType()
                                                                .withUUIDIdentifikator("251c24fd-57b0-4afc-9d73-b063d1957eb3")
                                                        )
                                                        .withType(new UnikIdType()
                                                ...
                                                .withOekonomiskEffektueringPart(List.of(new oio.sts.ydelse.oekonomiskeffektueringindeks._6.OekonomiskEffektueringIndeksPartRelationType()
                                                        .withBrugervendtNoegle() // Blank / Not to be utilized
                                                        .withFuldtNavn("Lonnie Pedersen")
                                                        .withVirkning(new VirkningType()
                                                                .withFraTidspunkt(new TidspunktType()
                                                                        .withTidsstempelDatoTid(SoapUtils.getXmlCalender("2024-01-01T12:00:00"))
